...
RSpec.describe SearchOptions do
  describe '.parse' do
    ...
    it 'parses both supported options' do
      result = described_class.parse(%w[rails --license MIT --most-downloads-first])
    ...
    it 'parses aliases for options' do
      result = described_class.parse(%w[rspec --licence MIT --recent-first])
